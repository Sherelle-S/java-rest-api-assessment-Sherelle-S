...
//         TypeReference<HashMap<CreateWatchlist, CreateWatchlist>> typeRef = new TypeReference<HashMap<CreateWatchlist, CreateWatchlist>>(){};
//         Map<CreateWatchlist, CreateWatchlist> map = mapper.readValue(jsonInput, typeRef);
//         return map.toString();
